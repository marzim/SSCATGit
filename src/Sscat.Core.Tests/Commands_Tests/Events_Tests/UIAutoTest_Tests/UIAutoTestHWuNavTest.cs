// <copyright file="UIAutoTestHWuNavTest.cs" company="NCR">
...
namespace Sscat.Core.Tests.Commands_Tests.Events_Tests.UIAutoTest_Tests
{
    ...
    /// <summary>
    /// UIAutoTestHWuNav Test Class.
    /// </summary>
    [TestClass]
    public class UIAutoTestHWuNavTest
    {
        /// <summary>
        ...
        /// <summary>
        /// UIAutoTestHWuNav object under test.
        /// </summary>
        private UIAutoTestHWuNav _uiAutoTestHWuNav;
        ...
        public void TestInitialize()
        {
            ...
            _uiAutoTestHWuNav = new UIAutoTestHWuNav(
        ...
        /// <summary>
        /// Tests if the UIAutoTestHWUNav event will click the button.
        /// </summary>
        [TestMethod]
        public void TestUIAutoTestHwUNav_Run_ButtonIsClicked()
        {
            // arrange

            // act
            _uiAutoTestHWuNav.Run();

            // assert
            _nextGenUITestClientMock.Verify(x => x.ClickHWuNav(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()), Times.Once());
        }
    }
}
