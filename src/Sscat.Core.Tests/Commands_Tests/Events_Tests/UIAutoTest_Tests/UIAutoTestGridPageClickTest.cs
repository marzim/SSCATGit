// <copyright file="UIAutoTestGridPageClickTest.cs" company="NCR">
...
namespace Sscat.Core.Tests.Commands_Tests.Events_Tests.UIAutoTest_Tests
{
    ...
    /// <summary>
    /// UIAutoTestGridPageClick Test class.
    /// </summary>
    [TestClass]
    public class UIAutoTestGridPageClickTest
    {
        /// <summary>
        ...
        /// <summary>
        /// UIAutoTestGridPageClick object under test.
        /// </summary>
        private UIAutoTestGridPageClick _uiAutoTestGridPageClick;
        ...
        public void TestInitialize()
        {
            ...
            _uiAutoTestGridPageClick = new UIAutoTestGridPageClick(
        ...
        /// <summary>
        /// Tests if the UIAutoTestGridPageClick event will click the button.
        /// </summary>
        [TestMethod]
        public void TestUIAutoTestGridPageClick_Run_ButtonIsClicked()
        {
            // arrange

            // act
            _uiAutoTestGridPageClick.Run();

            // assert
            _nextGenUITestClientMock.Verify(x => x.ClickSlidingGridPage(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()), Times.Once());
        }
    }
}
