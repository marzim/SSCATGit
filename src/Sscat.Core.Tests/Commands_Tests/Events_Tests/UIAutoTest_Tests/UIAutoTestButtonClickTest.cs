// <copyright file="UIAutoTestButtonClickTest.cs" company="NCR">
...
namespace Sscat.Core.Tests.Commands_Tests.Events_Tests.UIAutoTest_Tests
{
    ...
    /// <summary>
    /// UIAutoTestButtonClick Test Class.
    /// </summary>
    [TestClass]
    public class UIAutoTestButtonClickTest
    {
        /// <summary>
        ...
        /// </summary>
        private UIAutoTestButtonClick _uiAutoTestButtonClick;
        ...
        public void TestInitialize()
        {
            ...
            _uiAutoTestButtonClick = new UIAutoTestButtonClick(
        ...
        /// <summary>
        /// Tests if the UIAutoTestButtonClick event will click the button.
        /// </summary>
        [TestMethod]
        public void TestUIAutoTestButtonClick_Run_ButtonIsClicked()
        {
            // arrange

            // act
            _uiAutoTestButtonClick.Run();

            // assert
            _nextGenUITestClientMock.Verify(x => x.ClickButton(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()), Times.Once());
        }
    }
}
