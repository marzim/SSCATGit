// <copyright file="UIAutoTestSignSignatureTest.cs" company="NCR">
...
namespace Sscat.Core.Tests.Commands_Tests.Events_Tests.UIAutoTest_Tests
{
    ...
    /// <summary>
    /// UIAutoTestSignSignature Test Class.
    /// </summary>
    [TestClass]
    public class UIAutoTestSignSignatureTest
    {
        /// <summary>
        ...
        /// <summary>
        /// UIAutoTestSignSignature object under test.
        /// </summary>
        private UIAutoTestSignSignature _uiAutoTestSignSignature;
        ...
        public void TestInitialize()
        {
            ...
            _uiAutoTestSignSignature = new UIAutoTestSignSignature(
        ...
        /// <summary>
        /// Tests if the UIAutoTestSignSignature event will sign.
        /// </summary>
        [TestMethod]
        public void TestUIAutoTestSignSignature_Run_Signed()
        {
            // arrange

            // act
            _uiAutoTestSignSignature.Run();

            // assert
            _nextGenUITestClientMock.Verify(x => x.SignSignature(It.IsAny<string>(), It.IsAny<string>()), Times.Once());
        }
    }
}
