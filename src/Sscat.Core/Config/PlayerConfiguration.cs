...
namespace Sscat.Core.Config
{
    ...
    public class PlayerConfiguration : BaseModel<PlayerConfiguration>, IDisposable, IContent
    {
        ...
        /// <summary>
        /// Whether or not solution has enter password screen
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to solution has enter password screen
        /// </summary>
        [XmlAttribute("EnterPasswordEnable")]
        public bool EnterPasswordEnable
        {
            get { return _enterPasswordEnable; }
            set { _enterPasswordEnable = value; }
        }
