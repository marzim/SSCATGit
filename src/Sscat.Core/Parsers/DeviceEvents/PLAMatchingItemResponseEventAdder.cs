// <copyright file="PLAMatchingItemResponseEventAdder.cs" company="NCR">
...
namespace Sscat.Core.Parsers.DeviceEvents
{
    ...
    /// <summary>
    /// Initializes a new instance of the PLAMatchingItemResponseEventAdder class
    /// </summary>
    public class PLAMatchingItemResponseEventAdder : DeviceEventAdder
    {
        /// <summary>
        /// Initializes a new instance of the PLAMatchingItemResponseEventAdder class
        /// </summary>
        public PLAMatchingItemResponseEventAdder()
            : base(Constants.DeviceType.PLA_MATCHING_ITEM_RESPONSE)
        {
        }
