// <copyright file="PLAVerifyItemInterventionEventAdder.cs" company="NCR">
...
namespace Sscat.Core.Parsers.DeviceEvents
{
    ...
    /// <summary>
    /// Initializes a new instance of the PLAVerifyItemInterventionEventAdder class
    /// </summary>
    public class PLAVerifyItemInterventionEventAdder : DeviceEventAdder
    {
        /// <summary>
        /// Initializes a new instance of the PLAVerifyItemInterventionEventAdder class
        /// </summary>
        public PLAVerifyItemInterventionEventAdder()
            : base(Constants.DeviceType.PLA_VERIFY_ITEM_INTERVENTION)
        {
        }
