// <copyright file="UIAutoTestButtonClickEventAdder.cs" company="NCR">
...
namespace Sscat.Core.Parsers.UIAutoTestEvents
{
    ...
    /// <summary>
    /// Initializes a new instance of the UIAutoTestButtonClickEventAdder class
    /// </summary>
    public class UIAutoTestButtonClickEventAdder : UIAutoTestEventAdder
    {
        /// <summary>
        /// Initializes a new instance of the UIAutoTestButtonClickEventAdder class
        /// </summary>
        public UIAutoTestButtonClickEventAdder()
            : base()
        {
        }
        ...
        public override void Add(string line, Match match, IExtendedTextReader reader, List<IScriptEvent> events, string eventValue)
        {
            ...
            item.EventType = Constants.UIAutoTestEvent.BUTTON_CLICK;
            ...
            if (!item.ButtonName.Equals("masked"))
            {
