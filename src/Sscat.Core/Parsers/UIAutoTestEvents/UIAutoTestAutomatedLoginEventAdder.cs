// <copyright file="UIAutoTestAutomatedLoginEventAdder.cs" company="NCR">
...
namespace Sscat.Core.Parsers.UIAutoTestEvents
{
    ...
    /// <summary>
    /// Initializes a new instance of the UIAutoTestAutomatedLoginEventAdder class
    /// </summary>
    public class UIAutoTestAutomatedLoginEventAdder : UIAutoTestEventAdder
    {
        /// <summary>
        /// Initializes a new instance of the UIAutoTestAutomatedLoginEventAdder class
        /// </summary>
        public UIAutoTestAutomatedLoginEventAdder()
            : base()
        {
        }
        ...
        public override void Add(string line, Match match, IExtendedTextReader reader, List<IScriptEvent> events, string eventValue)
        {
            ...
            item.EventType = Constants.UIAutoTestEvent.AUTOMATED_LOGIN;
            item.ValidLogin = "1";
