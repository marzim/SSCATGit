// <copyright file="UIAutoTestContextChangedEventAdder.cs" company="NCR">
...
namespace Sscat.Core.Parsers.UIAutoTestEvents
{
    ...
    /// <summary>
    /// Initializes a new instance of the UIAutoTestContextChangedEventAdder class
    /// </summary>
    public class UIAutoTestContextChangedEventAdder : UIAutoTestEventAdder
    {
        /// <summary>
        /// Initializes a new instance of the UIAutoTestContextChangedEventAdder class
        /// </summary>
        public UIAutoTestContextChangedEventAdder()
            : base()
        {
        }
        ...
        public override void Add(string line, Match match, IExtendedTextReader reader, List<IScriptEvent> events, string eventValue)
        {
            ...
            item.EventType = Constants.UIAutoTestEvent.CONTEXT_CHANGED;
