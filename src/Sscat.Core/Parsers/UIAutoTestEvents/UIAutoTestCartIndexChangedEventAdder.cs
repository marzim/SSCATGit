// <copyright file="UIAutoTestCartIndexChangedEventAdder.cs" company="NCR">
...
namespace Sscat.Core.Parsers.UIAutoTestEvents
{
    ...
    /// <summary>
    /// Initializes a new instance of the UIAutoTestCartIndexChangedEventAdder class
    /// </summary>
    public class UIAutoTestCartIndexChangedEventAdder : UIAutoTestEventAdder
    {
        /// <summary>
        /// Initializes a new instance of the UIAutoTestCartIndexChangedEventAdder class
        /// </summary>
        public UIAutoTestCartIndexChangedEventAdder()
            : base()
        {
        }
        ...
        public override void Add(string line, Match match, IExtendedTextReader reader, List<IScriptEvent> events, string eventValue)
        {
            ...
            item.EventType = Constants.UIAutoTestEvent.CART_INDEX_CHANGED;
