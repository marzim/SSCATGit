// <copyright file="UIAutoTestCategoryClickEventAdder.cs" company="NCR">
...
namespace Sscat.Core.Parsers.UIAutoTestEvents
{
    ...
    /// <summary>
    /// Initializes a new instance of the UIAutoTestCategoryClickEventAdder class
    /// </summary>
    public class UIAutoTestCategoryClickEventAdder : UIAutoTestEventAdder
    {
        /// <summary>
        /// Initializes a new instance of the UIAutoTestCategoryClickEventAdder class
        /// </summary>
        public UIAutoTestCategoryClickEventAdder()
            : base()
        {
        }
        ...
        public override void Add(string line, Match match, IExtendedTextReader reader, List<IScriptEvent> events, string eventValue)
        {
            ...
            item.EventType = Constants.UIAutoTestEvent.CATEGORY_CLICK;
