// <copyright file="UIAutoTestSwipeRightEventAdder.cs" company="NCR">
...
namespace Sscat.Core.Parsers.UIAutoTestEvents
{
    ...
    /// <summary>
    /// Initializes a new instance of the UIAutoTestSwipeRightEventAdder class
    /// </summary>
    public class UIAutoTestSwipeRightEventAdder : UIAutoTestEventAdder
    {
        /// <summary>
        /// Initializes a new instance of the UIAutoTestSwipeRightEventAdder class
        /// </summary>
        public UIAutoTestSwipeRightEventAdder()
            : base()
        {
        }
        ...
        public override void Add(string line, Match match, IExtendedTextReader reader, List<IScriptEvent> events, string eventValue)
        {
            ...
            item.EventType = Constants.UIAutoTestEvent.SWIPE_RIGHT;
