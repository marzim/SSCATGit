...
namespace Sscat.Core.Models.ScriptModel
{
    ...
    public class SSCATScriptEvent : AbstractScriptEvent<SSCATScriptEvent>
    {
        ...
        /// </summary>
        /// <param name="time">script time</param>
        /// <param name="dateTime">script event dateT and time</param>
        /// <param name="enabled">whether or not to enable</param>
        /// <param name="item">script event item</param>
        public SSCATScriptEvent(long time, DateTime dateTime, bool enabled, IScriptEventItem item)
            : this(time, dateTime, enabled, item, string.Empty)
        {
        }
        ...
        /// </summary>
        /// <param name="time">script time</param>
        /// <param name="dateTime">script event date and time</param>
        /// <param name="enabled">whether or not to enable</param>
        /// <param name="item">script event item</param>
        /// <param name="screenshotLink">screenshot link</param>
        public SSCATScriptEvent(long time, DateTime dateTime, bool enabled, IScriptEventItem item, string screenshotLink)
        {
            Time = time;
            Enabled = enabled;
            Item = item;
        ...
        /// </summary>
        [XmlIgnore]
        public override DateTime DateAndTime 
        {
            get { return base.DateAndTime; }
            set { base.DateAndTime = value; }
        }
