...
{
	[TestFixture]
	public class CheckChangeDueAndTenderTypeTests
	{
		CheckChangeDueAndTenderType command;
        ...
        public void OneTimeSetUp()
		{
			...
			command = new CheckChangeDueAndTenderType(lane.Hooks["Traces"], new DeviceEvent(), lane, 500, true);
		}
