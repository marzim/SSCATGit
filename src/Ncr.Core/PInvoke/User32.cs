...
namespace Ncr.Core.PInvoke
{
    ...
    public static class User32
    {
        ...
        /// <param name="wparam">Additional message-specific information.</param>
        /// <param name="lparam">Additional message-specific information</param>
        /// <param name="uflags">The behavior of this function. This parameter can be one or more of the following values. SMTO_ABORTIFHUNG,SMTO_BLOCK,SMTO_NORMAL..etc</param>
        /// <param name="timeout">The duration of the time-out period, in milliseconds.</param>
        ...
        /// <returns>The return value specifies the result of the message processing; it depends on the message sent.</returns>
        [DllImport("user32.dll", CharSet = CharSet.Auto)]
        public static extern IntPtr SendMessageTimeout(IntPtr handle, uint message, int wparam, StringBuilder lparam, uint uflags, uint timeout, int result);
        ...
        /// <summary>
        /// Places a message in the message queue associated with the thread 
        /// that created the specified window and returns without waiting for the thread to process the message.
        /// </summary>
        /// <param name="handle">A handle to the window whose window procedure is to receive the message. The following values have special meanings.</param>
        /// <param name="message">The message to be posted.</param>
        /// <param name="wparam">Additional message-specific information.</param>
        /// <param name="lparam">Left additional message-specific information.</param>
        /// <returns>If the function succeeds, the return value is nonzero</returns>
        [DllImport("user32.dll")]
        public static extern bool PostMessageA(IntPtr handle, uint message, int wparam, int lparam);
    }
}
