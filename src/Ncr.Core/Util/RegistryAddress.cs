...
namespace Ncr.Core.Util
{
    ...
    public static class RegistryAddress
    {
        ...
        /// <summary>
        /// PipeServer Key for Windows 32
        /// </summary>
        private static string pipeServerKey32 = @"SOFTWARE\NCR\SCOT\CurrentVersion\SCOTTB\PipeServer";

        /// <summary>
        /// PipeServer Key for Windows 64
        /// </summary>
        private static string pipeServerKey64 = @"SOFTWARE\NCR\SCOT\CurrentVersion\SCOTTB\PipeServer"; 
        ...
        /// <summary>
        /// Gets the PipeServer Key
        /// </summary>
        public static string PipeServerKey
        {
            get { return !SSCOHelper.Is64BitOperatingSystem() ? pipeServerKey32 : pipeServerKey64.Insert(9, "WOW6432Node\\"); }
        }
    }
}
