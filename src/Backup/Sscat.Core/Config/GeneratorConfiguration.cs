...
namespace Sscat.Core.Config
{
    ...
    public class GeneratorConfiguration : BaseModel<GeneratorConfiguration>, IContent
    {
        ...
        public override void Validate()
        {
            ...
            AddErrorIf("You may have used the same script name before and forgot to delete the corresponding \"Configuration Folder\" where SSCAT saves all the important SSCO config files. Please delete/rename the folder or choose another script filename.", Directory.Exists(_scriptOutputDirectory + "\\" + _scriptName));
        }
    }    
}
