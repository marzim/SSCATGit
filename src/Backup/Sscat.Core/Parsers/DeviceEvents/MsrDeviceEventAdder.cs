// <copyright file="MsrDeviceEventAdder.cs" company="NCR">
...
namespace Sscat.Core.Parsers.DeviceEvents
{
    ...
    /// <summary>
    /// Initializes a new instance of the MsrDeviceEventAdder class
    /// </summary>
    public class MsrDeviceEventAdder : DeviceEventAdder
    {
        /// <summary>
        /// Initializes a new instance of the MsrDeviceEventAdder class
        /// </summary>
        public MsrDeviceEventAdder()
            : base(Constants.DeviceType.MSR)
        {
        }
